...
RSpec.describe ContactsController, type: :controller do
  customer = Customer.create!(first_name: "Richard", last_name: "Wise", address1: "13308 W 96th Ter", city: "Smithville", state: "KS", zip: "66042")
  # This should return the minimal set of attributes required to create a valid
  # Contact. As you add validations to Contact, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) {
    { date: "2017-03-15", reason: "String", details: "String", customer_id: 1}
  }

  let(:invalid_attributes) {
    { date: "", reason: "", details: "", customer_id: nil }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contact" do
        ...
        contact.reload
        expect(contact.reason).to eq("Test")
      end
